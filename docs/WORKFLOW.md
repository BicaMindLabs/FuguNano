...
Research basis: 1-2 rounds capture most reachable improvement, a hard cap prevents oscillation, and generation != review keeps the verifier independent. The memory step follows [Reflexion](https://arxiv.org/abs/2303.11366), [Self-Refine](https://arxiv.org/abs/2303.17651), [Agent Workflow Memory](https://arxiv.org/abs/2409.07429), [AgentHER](https://arxiv.org/abs/2603.21357), [MemRL](https://arxiv.org/abs/2601.03192), and recent stale/evolving/provenance-aware agent-memory work such as [STALE](https://arxiv.org/abs/2605.06527), [SSGM](https://arxiv.org/abs/2603.11768), [Agent Memory: Characterization and System Implications](https://arxiv.org/abs/2606.06448), [MemMachine](https://arxiv.org/abs/2604.04853), [PROV-AGENT](https://arxiv.org/abs/2508.02866), [Securing LLM-Agent Long-Term Memory Against Poisoning](https://arxiv.org/abs/2606.24322), and [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329): useful traces should become reusable verbal feedback, but failed traces must be explicitly relabeled, stale traces must be explicitly gated, and imported traces should keep write-time origin metadata before replay. FuguNano's `experience learn --allow-failure --lesson ... --failure-cause <cause>` writes that relabel with `source=task:<TASK.md>` provenance; `experience add --source-ref <ref> --trust untrusted` marks imported/browser/model-derived notes with a visible origin plus write-time trust; `experience recall --failure-cause <cause> --source <manual|task> --source-ref <ref> --trust <trusted|untrusted|all> --min-score <n> --max-age-days <n> --explain` filters by failure mode, source class, exact write-time source reference, trust, utility, and freshness before ranking, and prints retrieval/source/trust/freshness evidence. `workspace context --experience-source <manual|task> [--experience-source-ref <ref>] --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` and `dispatch --workspace ... --experience-source <manual|task> [--experience-source-ref <ref>] --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` apply the same source route, trusted-only default, explicit injection budget, and optional freshness window before automatic prompt assembly. The source/source-ref/trust/freshness filters are operator routing and audit primitives, not complete formal authority boundaries. Harness evolution follows [Self-Harness](https://arxiv.org/abs/2606.09498) and related retrospective harness optimization work such as [RHO](https://arxiv.org/abs/2606.05922).
