...
fuguectl experience learn code "failed-query retro" --task ~/.claude/tasks/TASK-2026-06-28-055.md --allow-failure --lesson "Score relevance on title/body tokens only"
