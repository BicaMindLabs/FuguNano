...
fuguectl experience recall code --failure-cause retrieval --source task --source-ref ~/.claude/tasks/TASK-2026-06-28-055.md --trust trusted --query "dispatch output" --min-score 2 --max-age-days 30 --explain  # cause/source/source-ref/trust/freshness filters + utility gate + evidence
